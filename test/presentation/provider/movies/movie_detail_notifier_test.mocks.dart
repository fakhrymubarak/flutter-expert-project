...
import 'package:ditonton/domain/repositories/tv_shows_repository.dart' as _i4;
...
class _FakeTvShowRepository_2 extends _i1.SmartFake
  ...
  _FakeTvShowRepository_2(Object parent, Invocation parentInvocation)
      : super(parent, parentInvocation);
}
...
class MockGetMovieWatchListStatus extends _i1.Mock
  ...
  _i2.MovieRepository get mRepository =>
      (super.noSuchMethod(Invocation.getter(#mRepository),
          ...
          as _i2.MovieRepository);
  @override
  _i4.TvShowRepository get tRepository => (super.noSuchMethod(
          Invocation.getter(#tRepository),
          returnValue:
              _FakeTvShowRepository_2(this, Invocation.getter(#tRepository)))
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSaveWatchlist extends _i1.Mock implements _i12.SaveMovieWatchlist {
  MockSaveWatchlist() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class MockRemoveWatchlist extends _i1.Mock implements _i13.RemoveMovieWatchlist {
  MockRemoveWatchlist() {
    _i1.throwOnMissingStub(this);
  }
